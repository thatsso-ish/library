                            ...
                            <form method="post" action="propertygrid.php">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 col-lg-2">
									 ...
									 <div class="col-md-3 col-lg-2">
										...
										<label> Min price (R) </label>
                                            <input type="number" class="form-control" name="p1" value="800.00" required>
                                        </div>
                                    </div>
									 <div class="col-md-3 col-lg-2">
                                        <div class="form-group">
										<label> Max price (R) </label>
                                            <input type="number" class="form-control" name="p2" value="6500.00" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4 col-lg-2">
										...
										<label></label>
										<label></label>
                                            <button type="submit" style="text-align:center" name="filter" class="btn btn-success w-100">Search Property</button>
                                        </div>
                                    </div>
                                </div>
                            </form>
                    ...
                    <div class="row">
                        <div class="col-lg-3 col-md-6">
                            <div class="p-4 text-center hover-bg-white hover-shadow rounded mb-4 transation-3s"> 
                                ...
                                <h5 class="text-secondary hover-text-success py-3 m-0"><a href="#">Viewing Apartment</a></h5>
                                <p></p>
                            </div>
                        </div>
                        <div class="col-lg-3 col-md-6">
                        ...
                        <div class="tab-content mt-4" id="pills-tabContent">
                            <div class="tab-pane fade show active" id="pills-home" role="tabpanel" aria-labelledby="pills-home">
                                <div class="row">
									...
									<?php $query=mysqli_query($con,"SELECT property.*, tittledeed.landlord FROM `property`,`tittledeed` WHERE property.tittledeedID=tittledeed.titledeed ORDER BY date DESC LIMIT 9");
                                    ...
                                    <div class="col-md-6 col-lg-4">
                                        <div class="featured-thumb hover-zoomer mb-4">
                                            <div class="overlay-black overflow-hidden position-relative"> <img src="Landlord/property/<?php echo $row['14'];?>" alt="pimage">
                                                <div class="featured bg-success text-white">New</div>
                                                <div class="sale bg-success text-white text-capitalize">For <?php echo $row['4'];?></div>
                                                <div class="price text-primary"><b>R<?php echo $row['9'];?> </b><span class="text-white"><?php echo $row['8'];?> Sqft</span></div>
                                            </div>
                                            <div class="featured-thumb-data shadow-one">
                                                <div class="p-3">
                                                    <h5 class="text-secondary hover-text-success mb-2 text-capitalize"><a href="?pid=<?php echo $row['0'];?>"><?php echo $row['1'];?></a></h5>
                                                ...
                                                <div class="bg-gray quantity px-4 pt-4">
                                                    <ul>
                                                        ...
                                                        <li><span><?php echo $row['5'];?></span> Beds</li>
                                                        <li><span><?php echo $row['6'];?></span> Baths</li>
                                                ...
                                                <div class="p-4 d-inline-block w-100">
                                                    <div class="float-left text-capitalize"><i class="fas fa-user text-success mr-1"></i>By : <?php echo $row['landlord'];?></div>
                            ...
                            <ul>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>RentaNathi is a top rated company that provide excellent services to it's customers</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p>RentaNathi have 10+ years of experience in service it's loyal customers.</p>
									</div>
                                </li>
                                <li class="mb-4 text-white d-flex"> 
									...
									<div class="pl-2">
										...
										<p> We are a professional organization that ensures customer satisfaction</p>
									</div>
                                </li>
                            </ul>
                        </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">View Property</h5>
                            <p>View property listing on our website</p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
                            ...
                            <h5 class="text-secondary mt-5 mb-4">Set Up Viewing appointment</h5>
                            <p>Set up appointment for viewing the property </p>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="icon-thumb-one text-center mb-5">
