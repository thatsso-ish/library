                ...
                <div class="row">
					...
					<div class="col-lg-8">
                        <div class="row">
							...
							<?php 
							$query=mysqli_query($con,"SELECT property.*, tittledeed.landlord FROM `property`,`tittledeed` WHERE property.tittledeedID=tittledeed.titledeed");
                                ...
                                <div class="featured-thumb hover-zoomer mb-4">
                                    ...
                                    <div class="featured-thumb-data shadow-one">
										...
										<a href="propertydetail.php?pid=<?php echo $row['0'];?>" class="bg-success d-table px-3 py-2 rounded text-white text-capitalize"><i class="fas fa-bell text-success font-20"></i>View Apartment details</a>
                                            ...
                                            <span class="location text-capitalize"><i class="fas fa-map-marker-alt text-success"></i> <?php echo $row['location'].", ".$row['city'];?></span> </div>
